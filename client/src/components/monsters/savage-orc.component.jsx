...
import SavageOrcIcon from '../../assets/images/monster-icons/savage-orc.svg';
...
const SavageOrc = ({points, id, hitpoints, location, monsterregion, targetable, niceshot, displayNewMessage, setMonsterRegion, toggleNiceShot, toggleTargetable, unselectCard, driveitback,
    ...
    return (
        ...
        <SVG src={SavageOrcIcon} className='monster' key={id ? id : null} onClick={handleClick}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(SavageOrc);