...
import GoblinIcon from '../../assets/images/monster-icons/goblin.svg';
...
const Goblin = ({points, id, hitpoints, location, monsterregion, targetable, niceshot, displayNewMessage, setMonsterRegion, toggleNiceShot, toggleTargetable, unselectCard, driveitback,
    ...
    return (
        ...
        <SVG src={GoblinIcon} className='monster' key={id ? id : null} onClick={handleClick}/>
