...
import WyvernIcon from '../../assets/images/monster-icons/wyvern.svg';
...
const Wyvern = ({points, id, hitpoints, location, monsterregion, targetable, niceshot, displayNewMessage, setMonsterRegion, toggleNiceShot, toggleTargetable, unselectCard, driveitback,
    ...
    return (
        ...
        <SVG src={WyvernIcon} className='monster' key={id ? id : null} onClick={handleClick}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(Wyvern);