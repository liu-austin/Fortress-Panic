...
import GiantIcon from '../../assets/images/monster-icons/giant.svg';
...
const Giant = ({points, id, hitpoints, location, monsterregion, targetable, niceshot, displayNewMessage, setMonsterRegion, toggleNiceShot, toggleTargetable, unselectCard, driveitback,
    ...
    return (
        <div className='monster-container giant-container'>
        <SVG src={GiantIcon} className='monster' key={id ? id : null} onClick={handleClick}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(Giant);