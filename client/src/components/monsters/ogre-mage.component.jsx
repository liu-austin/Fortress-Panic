...
const OgreMage = ({id, hitpoints, location, monsterregion, targetable, niceshot, displayNewMessage, setMonsterRegion, toggleNiceShot, toggleTargetable}) => {
    const handleClick = () => {
    ...
    return (
        <div className='monster-container'>
            <OgreMageIcon className='monster' key={id ? id : null} onClick={handleClick}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(OgreMage);