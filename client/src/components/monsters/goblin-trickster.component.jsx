...
import GoblinTricksterIcon from '../../assets/images/monster-icons/goblin-trickster.svg';
...
const GoblinTrickster = ({points, id, hitpoints, location, monsterregion, targetable, niceshot, displayNewMessage, setMonsterRegion, toggleNiceShot, toggleTargetable, unselectCard, driveitback,
    ...
    return (
        ...
        <SVG src={GoblinTricksterIcon} className='monster' key={id ? id : null} onClick={handleClick}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(GoblinTrickster);