...
const Overlord = ({points, id, hitpoints, location, monsterregion, targetable, niceshot, displayNewMessage, setMonsterRegion, toggleNiceShot, toggleTargetable, unselectCard, driveitback,
...
export default connect(mapStateToProps, mapDispatchToProps)(Overlord);