...
import OrcWarlordIcon from '../../assets/images/monster-icons/orc-warlord.svg';
...
const OrcWarlord = ({points, id, hitpoints, location, monsterregion, targetable, niceshot, displayNewMessage, setMonsterRegion, toggleNiceShot, toggleTargetable, unselectCard, driveitback,
    ...
    return (
        ...
        <SVG src={OrcWarlordIcon} className='monster' key={id ? id : null} onClick={handleClick}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(OrcWarlord);